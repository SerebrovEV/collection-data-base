...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> commands = List.of(
                ...
                "INSERT VALUES 'lastName' = 'ADtestD' , 'id'= 4, 'age'= 41, 'active'= false",
                "INSERT VALUES 'id'= 5, 'age'= 10, 'active'= true",
                "INSERT VALUES 'lastName' = 'Test6' , 'id'= 6, 'age'= 48, 'cost'=6.8",
                "INSERT VALUES 'lastName' = 'Test7' , 'id'= 7, 'age'= 41, 'active'= true",
                "INSERT VALUES 'lastName' = 'Test' , 'id'= 8, 'age'= 43, 'active'= true",
